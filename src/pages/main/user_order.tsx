              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>{order.status === "terminated" ? "Your ADA will be refunded to your wallet." : "This action cannot be undone. This will set the order to be accepted."} </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
