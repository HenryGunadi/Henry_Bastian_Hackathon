...
export default function Home() {
  ...
  async function handleWithdraw() {
    ...
    await withdrawFundTx();
  }

  async function withdrawFundTx(): Promise<void> {
    try {
  ...
  async function withdrawFundTxHelper(vestingUtxo: UTxO): Promise<void | string> {
    try {
      ...
      await txBuilder
        ...
        .txInRedeemerValue(mConStr0([mConStr0([stringToHex("hello")])])) // withdraw key
        .txOut(walletAddress, [])
