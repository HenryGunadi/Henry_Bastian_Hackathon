    ...
    <div className="min-h-screen bg-slate-900 w-full text-white text-center">
      ...
      {connected && (
        <div className="flex-col justify-center items-center">
          <div className="mb-4">
            <input className="bg-slate-700 border border-white rounded-lg px-3 py-2 w-1/3" type="number" placeholder="Jumlah ADA yang Akan di Depostikan" onChange={amountHandler} />
          </div>
          <div>
            <button className="border border-white rounded-xl bg-blue-700 hover:bg-blue-500 hover:font-bold py-2 w-1/3" onClick={handleDeposit}>
              Deposit
            </button>
          </div>
        </div>
